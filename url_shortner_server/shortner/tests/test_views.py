...
class TestViews(TestCase):
    ...
    def test_stats_view_authenticated(self):
        ...
        self.client.post(
            reverse("signin"), {"username": "newuser123", "pass1": "password123"}
        )
    ...
    def test_stats_view_sorting(self):
        ...
        self.assertEqual(
            response.context["list_of_links"][0]["long_url"], "https://www.example1.com"
        )
        self.assertEqual(
            response.context["list_of_links"][1]["long_url"], "https://www.example2.com"
        )
    ...
    def test_export_csv_multiple_links(self):
        ...
        self.client.post(
            reverse("signin"), {"username": "newuser456", "pass1": "mypassword"}
        )
    ...
    def test_export_csv_empty_links(self):
        ...
        self.client.post(
            reverse("signin"), {"username": "newuser789", "pass1": "mypassword"}
        )
        response = self.client.get(reverse("export_csv"))
        content = response.content.decode("utf-8")
        csv_reader = csv.reader(io.StringIO(content))
    ...
    def test_stats_view_context(self):
        ...
        self.client.post(
            reverse("signin"), {"username": "newuser321", "pass1": "mypassword"}
        )
        long_url = "https://www.example.com"
        self.client.post(reverse("add_new"), {"long-url": long_url})
    ...
    def test_stats_view_link_details(self):
        ...
        self.client.post(
            reverse("signin"), {"username": username, "pass1": signup_data["pass1"]}
        )
    ...
    def test_export_csv_filename(self):
        ...
        self.client.post(reverse("signup"), signup_data)
        self.client.post(
            reverse("signin"), {"username": username, "pass1": "mypassword"}
        )
